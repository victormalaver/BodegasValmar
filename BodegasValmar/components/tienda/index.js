    ...
    var dataProvider = app.data.bodegas,
        ...
        tiendaModel = kendo.observable({
            ...
            setCurrentItemByUid: function (uid) {
                ...
                var metodo_pago = "";
                for (var i = 0; i < itemModel.metodoPagoExpanded.length; i++) {
                    metodo_pago = metodo_pago + itemModel.metodoPagoExpanded[i] + (((i + 1) == itemModel.metodoPagoExpanded.length) ? "" : " - ");
                }
                itemModel.metodoPagoExpanded = metodo_pago;
                if (!itemModel.nombre) {
